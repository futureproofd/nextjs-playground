  ...
  Essentially what it's comprised of is:  

  - A frontend placeholder for the Widget:
  ...
  - The full implementation looks as follows:
    - We invoke startup() to initialize our UI Widget on our placeholder control
  ...
  Writing functional components on the frontend using the native fetch API is a preferable to the above.