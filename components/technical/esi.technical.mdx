...
One interesting feature that isn't React-specific, but rather relies on the usage of Javascript classes and decorators, was to provide a Redux store
for the application. The Redux abstraction itself [(easy-peasy)](https://easy-peasy.dev/) isn't central to the technique, but some of it's API methods will appear
